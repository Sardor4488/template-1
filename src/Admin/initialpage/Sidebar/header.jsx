   ...
   render() {
    ...
    let pathname = location.pathname
      ...
      return (        
        ...
        {/* /Logo */}
        <a href={"#"} id="toggle_btn">	<i className="fas fa-bars" />
        </a>
        <div className="top-nav-search">
          <form>
            <input type="text" className="form-control" placeholder="Search here" />
            <button className="btn" type="submit"><i className="feather-search" />
            </button>
          </form>
        </div>
        {/* Mobile Menu Toggle */}
        <a className="mobile_btn" id="mobile_btn">	<i className="fas fa-bars" />
        </a>
        {/* /Mobile Menu Toggle */}
        {/* Header Right Menu */}
        <ul className="nav user-menu">
          ...
          <li className="nav-item dropdown has-arrow flag-nav mr-2">
            <a className="nav-link dropdown-toggle align-items-center" data-toggle="dropdown" href="#" role="button">
              <img src={US_FLAG} alt="" width={24} height={16} className="lang-flag mr-1" /> English 
            </a>
          ...
          <li className="nav-item dropdown has-arrow main-drop ml-3">
            <a href="#" className="dropdown-toggle nav-link" data-toggle="dropdown">
              <span className="user-img"><img src={AVATAR_06} alt="" /> Admin
                <span className="status online" /></span>
            </a>
            <div className="dropdown-menu">
              <Link className="dropdown-item" to="/admin/profile"><i className="feather-user" /> My Profile</Link> 
              <Link className="dropdown-item" to="/admin_login"><i className="feather-power" /> Logout</Link>
            </div>
          </li>
        </ul>
        {/* /Header Right Menu */}
