                            ...
                            <ul className="main-nav">
                                ...
                                pathname.includes('add-blog') || pathname.includes('edit-blog') ? "has-submenu active" : "has-submenu"}>
                                    ...
                                    <ul className="submenu">
                                        <li className={pathname.includes('/Mentor/dashboard') ? "active" : ""}><Link
                                            to="/app/Mentor/dashboard">O'qituvchi Dashboard</Link></li>
                                        <li className={pathname.includes('Mentor/bookings') ? "active" : ""}><Link
                                            to="/app/Mentor/bookings">Bookings</Link></li>
                                        <li className={pathname.includes('schedule-timings') ? "active" : ""}><Link
                                            to="/app/Mentor/schedule-timings">Schedule Timing</Link></li>
                                        <li className={pathname.includes('mentee-list') ? "active" : ""}><Link
                                            to="/app/Mentor/mentee-list">Mentee List</Link></li>
                                        <li className={pathname.includes('profile-mentee') ? "active" : ""}><Link
                                            to="/app/Mentor/profile-mentee">Mentee Profile</Link></li>
                                        ...
                                        || pathname.includes('edit-blog') ? "has-submenu active" : "has-submenu"}>
                                            ...
                                            <ul className="submenu">
                                                <li className={pathname.includes('/Mentor/blog') ? "active" : ""}><Link
                                                    to="/app/Mentor/blog">Blog</Link></li>
                                                <li><Link to="/app/Blog/blog-details">Blog View</Link></li>
                                                <li className={pathname.includes('add-blog') ? "active" : ""}><Link
                                                    to="/app/Mentor/add-blog">Add Blog</Link></li>
                                                <li className={pathname.includes('edit-blog') ? "active" : ""}><Link
                                                    to="/app/Mentor/edit-blog">Edit Blog</Link></li>
                                            </ul>
                                        </li>
                                        <li className={pathname.includes('/Mentor/chat') ? "active" : ""}><Link
                                            to="/app/Mentor/chat">Chat</Link></li>
                                        <li className={pathname.includes('invoice') ? "active" : ""}><Link
                                            to="/app/Mentor/invoices">Invoices</Link></li>
                                        <li className={pathname.includes('/Mentor/profile-settings') ? "active" : ""}>
                                            <Link to="/app/Mentor/profile-settings">Profile Settings</Link></li>
                                        <li className={pathname.includes('reviews') ? "active" : ""}><Link
                                            to="/app/Mentor/reviews">Reviews</Link></li>
                                        <li className={pathname.includes('mentor-register') ? "active" : ""}><Link
                                            to="/app/Mentor/mentor-register">Mentor Register</Link></li>
                                    </ul>
                                </li>
                                ...
                                pathname.includes('change-password') ? "has-submenu active" : "has-submenu"}>
                                    ...
                                    <ul className="submenu">
                                        <li className={pathname.includes('map-grid') || pathname.includes('map-list')
                                            ...
                                            <a href="#">Mentors</a>
                                            <ul className="submenu">
                                                <li className={pathname.includes('map-grid') ? "active" : ""}><Link
                                                    to="/app/Mentee/map-grid">Map Grid</Link></li>
                                                <li className={pathname.includes('map-list') ? "active" : ""}><Link
                                                    to="/app/Mentee/map-list">Map List</Link></li>
                                            </ul>
                                        </li>
                                        <li className={pathname.includes('search') ? "active" : ""}><Link
                                            to="/app/Mentee/search">Search Mentor</Link></li>
                                        <li className={pathname.includes('mentor-profile') ? "active" : ""}><Link
                                            to="/app/Mentee/mentor-profile">O'qituvchi Profile</Link></li>
                                        <li className={pathname.includes('bookings-mentee') ? "active" : ""}><Link
                                            to="/app/Mentee/bookings-mentee">Bookings</Link></li>
                                        <li className={pathname.includes('checkout') ? "active" : ""}><Link
                                            to="/app/Mentee/checkout">Checkout</Link></li>
                                        <li className={pathname.includes('booking-success') ? "active" : ""}><Link
                                            to="/app/Mentee/booking-success">Booking Success</Link></li>
                                        <li className={pathname.includes('dashboard-mentee') ? "active" : ""}><Link
                                            to="/app/mentee/dashboard">Oquvchi Dashboard</Link></li>
                                        <li className={pathname.includes('favourites') ? "active" : ""}><Link
                                            to="/app/Mentee/favourites">Favourites</Link></li>
                                        <li className={pathname.includes('Mentee/chat-mentee') ? "active" : ""}><Link
                                            to="/app/Mentee/chat-mentee">Chat</Link></li>
                                        <li className={pathname.includes('profile-settings-mentee') ? "active" : ""}>
                                            <Link to="/app/Mentee/profile-settings-mentee">Profile Settings</Link></li>
                                        <li className={pathname.includes('change-password') ? "active" : ""}><Link
                                            to="/app/Mentee/change-password">Change Password</Link></li>
                                    </ul>
                                </li>
                                ...
                                pathname.includes('components') || pathname.includes('blank-page') ? "has-submenu active" : "has-submenu"}>
                                    ...
                                    <ul className="submenu">
                                        <li className={pathname.includes('voice-call') ? "active" : ""}><Link
                                            to="/app/Pages/voice-call">Voice Call</Link></li>
                                        <li className={pathname.includes('video-call') ? "active" : ""}><Link
                                            to="/app/Pages/video-call">Video Call</Link></li>
                                        <li><Link to="/app/Mentee/search">Search Mentors</Link></li>
                                        <li className={pathname.includes('components') ? "active" : ""}><Link
                                            to="/app/Pages/components">Components</Link></li>
                                        ...
                                        <li className={pathname.includes('blank-page') ? "active" : ""}><Link
                                            to="/app/Pages/blank-page">Starter Page</Link></li>
                                ...
                                pathname.includes('blog-details') ? "has-submenu active" : "has-submenu"}>
                                    ...
                                    <ul className="submenu">
                                        <li className={pathname.includes('blog-list') ? "active" : ""}><Link
                                            to="/app/Blog/blog-list">Blog List</Link></li>
                                        <li className={pathname.includes('blog-grid') ? "active" : ""}><Link
                                            to="/app/Blog/blog-grid">Blog Grid</Link></li>
                                        <li className={pathname.includes('blog-details') ? "active" : ""}><Link
                                            to="/app/Blog/blog-details">Blog Details</Link></li>
                                    </ul>
                                </li>
                                <li>
...
>>>>>>> 8731bb89237e55c71a6177533b488bb648dc9784
						...
						<img className="rounded-circle" src={USER} width={31} alt="Darren Elder"/>
                                    ...
                                    <div className="dropdown-menu dropdown-menu-right">
                                        ...
                                        <Link className="dropdown-item" to="/app/Mentor/profile-settings">Profile
                                            Settings</Link>
                                        <Link className="dropdown-item" to="/app/home" onClick={logout}>Logout</Link>
                                    </div>
                                </li>
                                {/* /User Menu */}
                            </ul>}
