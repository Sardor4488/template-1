...
>>>>>>> 8731bb89237e55c71a6177533b488bb648dc9784
            ...
            <div className="sidebar-bottom-show d-none  sidebar-bottom">
                <div className="row bg-white d-flex justufy-content-center align-items-center w-100">
                    <div className="col-3 border text-center shadow bg-white py-3  "><Link to="/app/index"> <i
                        className="fas fa-user"/> </Link></div>
                    <div className="col-3 border text-center shadow bg-white py-3  "><Link to="/app/index"> <i
                        className="fas fa-user-plus"/> </Link></div>
                    <div className="col-3 border text-center shadow bg-white py-3  "><Link to="/app/index"> <i
                        className="fas fa-home"/> </Link></div>
                    <div className="col-3 border text-center shadow bg-white py-3  "><Link to="/app/index"> <i
                        className="fas fa-home"/> </Link></div>
